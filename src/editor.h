...
typedef enum {
    ...
    KM_COMMAND_JUST_ONE_SPACE,
    KM_COMMAND_DELETE_INDENTATION,
    KM_COMMAND_DELETE_BLANK_LINES,
    KM_COMMAND_UPCASE_WORD,
    KM_COMMAND_DOWNCASE_WORD,
    KM_COMMAND_CAPITALIZE_WORD,
    KM_COMMAND_QUOTED_INSERT,
    KM_COMMAND_QUERY_REPLACE,
    ...
    KM_COMMAND_GOTO_CHAR,
    KM_COMMAND_MOVE_TO_WINDOW_LINE,
